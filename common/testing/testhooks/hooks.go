...
var (
	...
	HistoryTaskDLQDeleteInterceptor          = newKey[func(*historyservice.DeleteDLQTasksRequest, func() (*historyservice.DeleteDLQTasksResponse, error)) (*historyservice.DeleteDLQTasksResponse, error), global]()
