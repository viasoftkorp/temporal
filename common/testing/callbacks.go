...
// Returns a valid callbacks.ValidatorConfig that can be used to create a new
// callbacks.Validator. Tests can override fields to set arbitrary limits for
// aspects of the Validator to be tested.
func NewCallbacksValidatorConfig() callbacks.ValidatorConfig {
	...
	return callbacks.ValidatorConfig{
		...
		NexusHandlerSourceContextAggregateMaxSize: func(string) int { return 2000 },
	}
}
